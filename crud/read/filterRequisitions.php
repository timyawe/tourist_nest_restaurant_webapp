...
if(isset($_GET['station'])){
	...
	$sql = "SELECT _date, category, station, status, FROM PurchaseOrdersExtended WHERE Station = '$station' AND  ProductNo = '$pdtNo' AND `time` > curdate() - INTERVAL 1 DAY + INTERVAL 19 HOUR group by ordNo  ORDER BY time DESC";
}else{
