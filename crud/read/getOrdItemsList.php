...
if(isset($_GET['station'])){
	...
	$sql = "select Product_No AS value, Main_Product, if((SaleName = ''),Description,SaleName) AS label, UnitSalePrice AS rate, UnitCostPrice as PurchaseRate,
			...
			where (`nest_restaurant`.`products`.`Status` = 'Active') order by category, product_no";
}else{
